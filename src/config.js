...
export const QUALITY_PRESETS = Object.freeze({
  performance: { label: '性能', terrainSegments: 20, terrainRadius: 1, buildingRadius: 1, minBuildingArea: 45, pixelRatio: 1.0 },
  balanced: { label: '均衡', terrainSegments: 30, terrainRadius: 1, buildingRadius: 1, minBuildingArea: 24, pixelRatio: 1.35 },
  ultra: { label: '超清', terrainSegments: 42, terrainRadius: 2, buildingRadius: 1, minBuildingArea: 10, pixelRatio: 1.8 }
});
